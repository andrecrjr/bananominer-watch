export const checkYourWus = (dataBanano, dataFold) => {
  ...
  if (
    ...
    <section class="banano__info">
    <p>It seems your bananominer ID is inactive due to lack of recent folding activity. Please re-enter your ban_ address on &nbsp; <a href="http://www.bananominer.com" target="_blank" title="click here to visit">   bananominer.com</a></p>
    </section>
    </section>
    `;
  }
